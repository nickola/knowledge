...
Amazon Web Services (AWS) is reliable and scalable cloud computing services.
...
Private IPv4 address ranges (RFC 1918):
  - `10.0.0.0/8`: 10.0.0.0 - 10.255.255.255 (16 777 216 IPs), for example - 10.0.0.0/16.
  - `172.16.0.0/12`: 172.16.0.0 - 172.31.255.255 (1 048 576 IPs), for example - 172.31.0.0/16.
  - `192.168.0.0/16`: 192.168.0.0 - 192.168.255.255 (65 536 IPs), for example - 192.168.0.0/20 (192.168.0.0 - 192.168.15.255).
