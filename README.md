          ...
          args:
            - >
              while true; do
                ...
                echo "CONFIG_CUSTOM_VARIABLE1: $CONFIG_CUSTOM_VARIABLE1, CONFIG_CUSTOM_VARIABLE2: $CONFIG_CUSTOM_VARIABLE2";

                echo "SECRET_VARIABLE1: $SECRET_VARIABLE1, SECRET_VARIABLE2: $SECRET_VARIABLE2";
                echo "SECRET_CUSTOM_VARIABLE1: $SECRET_CUSTOM_VARIABLE1, SECRET_CUSTOM_VARIABLE2: $SECRET_CUSTOM_VARIABLE2";
